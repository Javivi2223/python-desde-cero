#juguemos a utilizar todas las otras estructuras de datos para combinarlas de forma de representar informacion mas compleja

recipes = {
  "pollo al horno": {
    "ingredients": ["pollo entero", "1 cebolla", "1 zanahoria", "2 dientes de ajo", "sal"],
  ...
  "carne al jugo": {
    "ingredients": ["carne de vacuno", "1 cebolla", "1 pimenton", "1 zanahoria", "sal"],
  ...
  "salmon al horno": {
    "ingredients": ["un filete de salmon", "zanahoria", "cebolla", "aliños"],
...
for meal in meals:
  ...
  print(f"{meal.title()}")
  print("----------------")
  ingredients = recipes[meal]["ingredients"]
  for ingredient in ingredients:
    print(f"-{ingredient}")

  print(recipes[meal]["steps"])      